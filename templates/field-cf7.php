...
<label for="<?php echo esc_attr(self::OPTION_PREFIX . $args['key']); ?>_sync">
	<?php echo esc_html__('Sync', 'linet-erp-woocommerce-integration'); ?></label>
	...
	<tbody>
		...
		foreach ($fields as $field) {
			...
			<tr>
				...
				<td>
					<select
						name='<?php echo esc_attr(self::OPTION_PREFIX . $args['key']); ?>[<?php echo esc_attr($field->name); ?>][value_type]'>
						<?php
				...
				<td>
					<input type='text'
						name='<?php echo esc_attr(self::OPTION_PREFIX . $args['key']); ?>[<?php echo esc_attr($field->name); ?>][linet_value]'
						value='<?php echo esc_attr($linet_value); ?>'
						placeholder=' <?php echo esc_html__('Linet Value', 'linet-erp-woocommerce-integration'); ?>' />
				</td>
			</tr>
			<?php
		}
